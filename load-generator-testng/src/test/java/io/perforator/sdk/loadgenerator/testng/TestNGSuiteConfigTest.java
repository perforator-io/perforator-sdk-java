...
public class TestNGSuiteConfigTest extends AbstractConfigTest<TestNGSuiteConfig> {

    public TestNGSuiteConfigTest() {
        super(TestNGSuiteConfig.class);
    }

    @Override
    protected Map<String, String> buildFieldsForVerification() throws Exception {
        return Map.of(
                TestNGSuiteConfig.Fields.suiteXmlFile, UUID.randomUUID().toString(),
