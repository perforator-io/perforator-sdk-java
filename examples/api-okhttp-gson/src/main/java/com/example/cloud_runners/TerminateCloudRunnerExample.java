...
public class TerminateCloudRunnerExample {

    Logger logger = LoggerFactory.getLogger(
            TerminateCloudRunnerExample.class
    );
    ...
    public void run() throws Exception {
        ...
        CloudRunner cloudRunner = cloudRunnersApi.terminateCloudRunner(
                projectKey,
                executionKey,
                cloudRunnerKey
        );
    ...
    public static void main(String[] args) throws Exception {
        new TerminateCloudRunnerExample().run();
    }
