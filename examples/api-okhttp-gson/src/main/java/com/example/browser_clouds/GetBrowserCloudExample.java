...
public class GetBrowserCloudExample {

    Logger logger = LoggerFactory.getLogger(
            GetBrowserCloudExample.class
    );
    ...
    public void run() throws Exception {
        ...
        BrowserCloud browserCloud = browserCloudsApi.getBrowserCloud(
                projectKey,
                executionKey,
                browserCloudKey
        );
    ...
    public static void main(String[] args) throws Exception {
        new GetBrowserCloudExample().run();
    }
