...
public class GetPulseNamespaceFieldsExample {

    Logger logger = LoggerFactory.getLogger(
            GetPulseNamespaceFieldsExample.class
    );
    ...
    public void run() throws Exception {
        ...
        logger.info("There are {} fields in pulse namespace", fields.size());
    ...
    public static void main(String[] args) throws Exception {
        new GetPulseNamespaceFieldsExample().run();
    }
