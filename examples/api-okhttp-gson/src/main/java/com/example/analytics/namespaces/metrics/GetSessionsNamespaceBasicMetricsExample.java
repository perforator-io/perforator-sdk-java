...
public class GetSessionsNamespaceBasicMetricsExample {

    Logger logger = LoggerFactory.getLogger(
            GetSessionsNamespaceBasicMetricsExample.class
    );
    ...
    public void run() throws Exception {
        ...
        logger.info(
                "There are {} basic metrics in sessions namespace => {}", 
                metrics.size(),
                metrics.stream()
    ...
    public static void main(String[] args) throws Exception {
        new GetSessionsNamespaceBasicMetricsExample().run();
    }
