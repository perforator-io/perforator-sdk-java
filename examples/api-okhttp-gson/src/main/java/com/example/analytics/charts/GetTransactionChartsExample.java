...
public class GetTransactionChartsExample {

    Logger logger = LoggerFactory.getLogger(
            GetTransactionChartsExample.class
    );
    ...
    public void run() throws Exception {
        ...
        chartsRequest.setCharts(List.of(transactionsChartRequest));
    ...
    public static void main(String[] args) throws Exception {
        new GetTransactionChartsExample().run();
    }
