...
public class GetPagesNamespaceFieldsExample {

    Logger logger = LoggerFactory.getLogger(
            GetPagesNamespaceFieldsExample.class
    );
    ...
    public void run() throws Exception {
        ...
        logger.info("There are {} fields in pages namespace", fields.size());
    ...
    public static void main(String[] args) throws Exception {
        new GetPagesNamespaceFieldsExample().run();
    }
