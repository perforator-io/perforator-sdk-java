...
public class GetSessionsNamespaceAdvancedMetricsExample {

    Logger logger = LoggerFactory.getLogger(
            GetSessionsNamespaceAdvancedMetricsExample.class
    );
    ...
    public void run() throws Exception {
        ...
        logger.info(
                "There are {} metrics in sessions namespace => {}, ... , displaying only the first {} metrics", 
                metrics.size(),
                metrics.stream()
    ...
    public static void main(String[] args) throws Exception {
        new GetSessionsNamespaceAdvancedMetricsExample().run();
    }
