...
public class GetRequestsNamespaceFieldsExample {

    Logger logger = LoggerFactory.getLogger(
            GetRequestsNamespaceFieldsExample.class
    );
    ...
    public void run() throws Exception {
        ...
        logger.info("There are {} fields in requests namespace", fields.size());
    ...
    public static void main(String[] args) throws Exception {
        new GetRequestsNamespaceFieldsExample().run();
    }
