...
public class GetRequestsNamespaceMetricsExample {

    Logger logger = LoggerFactory.getLogger(
            GetRequestsNamespaceMetricsExample.class
    );
    ...
    public void run() throws Exception {
        ...
        logger.info(
                "There are {} metrics in requests namespace => {}, ... , displaying only the first {} metrics", 
                metrics.size(),
                metrics.stream()
    ...
    public static void main(String[] args) throws Exception {
        new GetRequestsNamespaceMetricsExample().run();
    }
