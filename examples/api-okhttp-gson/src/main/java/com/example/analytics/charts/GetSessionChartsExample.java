...
public class GetSessionChartsExample {

    Logger logger = LoggerFactory.getLogger(
            GetSessionChartsExample.class
    );
    ...
    public void run() throws Exception {
        ...
        AnalyticsChartRequest sessionsChartRequest = new AnalyticsChartRequest();
        sessionsChartRequest.setNamespace(
                AnalyticsNamespace.SESSIONS.getValue()
        );
        sessionsChartRequest.setMetrics(List.of(
                SessionsBasicMetrics.COUNT.getValue(),
                SessionsBasicMetrics.DURATION_P90.getValue()
        ));
        sessionsChartRequest.setFilters(List.of(
                filter(
        ...
        chartsRequest.setCharts(List.of(sessionsChartRequest));
    ...
    public static void main(String[] args) throws Exception {
        new GetSessionChartsExample().run();
    }
